    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('package', models.FileField(null=True, upload_to='')),
            ],
        ),
        migrations.CreateModel(
            name='Interface',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('unit', models.CharField(choices=[('Version', 'Version of Installed Software'), ('n', 'Quantity'), ('Kbps', 'Kilobits/s'), ('KB', 'KiloBytes'), ('GHz', 'GHz')], help_text='Choose the measurement unit for the resource', max_length=10)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('name', models.CharField(max_length=100)),
                ('owners', models.ManyToManyField(related_name='pvns', to=settings.AUTH_USER_MODEL, verbose_name='PVN Owner')),
            ],
        ),
        migrations.CreateModel(
